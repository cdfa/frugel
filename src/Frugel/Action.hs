...
zipperAtCursor f = traverseNodeAt $ \cstrSiteOffset components -> maybeToRight
    (CstrSiteActionFailed cstrSiteOffset components)
    $ traverseOf _CstrSite (rezip <.> f <=< unzipTo cstrSiteOffset) components
